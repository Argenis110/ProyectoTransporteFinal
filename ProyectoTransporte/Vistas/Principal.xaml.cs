...
/* Cambio no fusionado mediante combinación del proyecto 'ProyectoTransporte (net7.0-maccatalyst)'
Antes:
using System;
...
/* Cambio no fusionado mediante combinación del proyecto 'ProyectoTransporte (net7.0-windows10.0.19041.0)'
Antes:
using System;
using System.Net.Http;
using Newtonsoft.Json;
...
/* Cambio no fusionado mediante combinación del proyecto 'ProyectoTransporte (net7.0-ios)'
Antes:
using System;
using System.Net.Http;
using Newtonsoft.Json;
